...
You'll likely want to [`bower cache clean`](/docs/api#cache-clean) after your change. `unregister` command is temporarily disabled but you can [request a package to be unregistered manually](https://github.com/bower/bower/issues/120).
